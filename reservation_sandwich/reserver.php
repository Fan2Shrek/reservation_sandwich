...
require_once 'php/connexion.php';
    ...
    {   
        ...
        {
            $db = connect();
            $statement = $db->prepare("INSERT INTO commande (fk_user_id,fk_sandwich_id, fk_boisson_id, fk_dessert_id, chips_com, date_heure_livraison_com) VALUES(?,?,?,?,?,?)");
                ...
                <div class='row'>
                    <div class='col-lg-6'>
                        <form method="post" action="" class='form'>
                            ...
                            <label for "sandwich"><img class="icon_res" src="images/sandwich.png"> Choisir le sandwich :
                            ...
                            <label for "boisson"><img class="icon_res" src="images/boisson.png"> Choisir la boisson :
                            ...
                            <label for "dessert"><img class="icon_res" src="images/dessert.png"> Choisir le dessert :
                            <select class='form-control' id='dessert' name='dessert'>
                                ...
                                <div>
                                    <label for="chips"><img class="icon_res" src="images/chips.png"> Chips :
                                    <input type="checkbox" id="chips" name="chips">
                                    <br>
                                    <label for="date"> Date de commande :
